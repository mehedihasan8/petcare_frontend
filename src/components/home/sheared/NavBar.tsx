...
const NavBar = () => {
  ...
  return (
    <div className="backdrop-blur-sm z-10 md:sticky w-full top-0">
      <div
        className={`flex justify-between items-center max-w-[1100px] mx-auto py-2 `}
      ...
      >
        ...
        <div className="md:flex items-center justify-between w-[55%] hidden">
          <ul className="flex items-center gap-4 ">
            ...
            <li>
              <Link className="nav-item" href={"/all-pets"}>
                All Pets
              </Link>
            </li>
          </ul>
